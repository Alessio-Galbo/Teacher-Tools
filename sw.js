const CACHE_NAME = "teachertools-v28";
...
const JS = [
  ...
  "./js/modules/settings/gdriveModal.js", "./js/modules/settings/cloudSection.js", "./js/modules/settings/backupSection.js", "./js/modules/settings/teacherProfileCard.js", "./js/modules/settings/settingsModal.js", "./js/modules/settings/settingsView.js",
