const CACHE_NAME = "teachertools-v11";
const CSS = ["variables", "base", "layout", "components/nav", "components/cards", "components/forms", "components/modal", "components/toast", "components/pei", "components/dossier", "components/notes", "components/studentBar", "components/school", "components/tree", "components/overview"].map((c) => `./css/${c}.css`);
const JS = [
  ...
  "./js/modules/notes/notesModel.js", "./js/modules/notes/noteItem.js", "./js/modules/notes/noteForm.js", "./js/modules/notes/noteModal.js", "./js/modules/notes/summaryModal.js", "./js/modules/notes/notesView.js",
