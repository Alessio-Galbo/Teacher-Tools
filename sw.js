const CACHE_NAME = "teachertools-v30";
const CSS = ["variables", "base", "layout", "components/nav", "components/cards", "components/forms", "components/modal", "components/toast", "components/pei", "components/dossier", "components/notes", "components/studentBar", "components/school", "components/tree", "components/overview", "components/rollover", "components/headerYear", "components/tools", "components/quiz", "components/quizPrint"].map((c) => `./css/${c}.css`);
...
const JS = [
  ...
  "./js/modules/settings/gdriveModal.js", "./js/modules/settings/cloudSection.js", "./js/modules/settings/backupSection.js", "./js/modules/settings/teacherProfileCard.js", "./js/modules/settings/pwaInstallModal.js", "./js/modules/settings/pwaInstallCard.js", "./js/modules/settings/settingsModal.js", "./js/modules/settings/settingsView.js",
