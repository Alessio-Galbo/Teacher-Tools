const CACHE_NAME = "teachertools-v108";
const CSS = ["variables", "base", "layout", "components/nav", "components/cards", "components/forms", "components/modal", "components/toast", "components/pei", "components/dossier", "components/dossierPrint", "components/notes", "components/studentBar", "components/school", "components/tree", "components/overview", "components/rollover", "components/headerYear", "components/tools", "components/quiz", "components/quizPrint", "components/settings", "components/splash", "components/lockScreen"].map((c) => `./css/${c}.css`);

const JS = [
  "./js/app.js", "./js/i18n.js", "./js/utils/dom.js", "./js/utils/toast.js", "./js/utils/renderHelper.js",
  "./js/services/db.js", "./js/services/snapshot.js", "./js/services/gdrive.js", "./js/services/backup.js", "./js/services/restoreService.js", "./js/services/studentService.js", "./js/services/pwaInstallService.js",
  ...
  "./js/modules/settings/gdriveModal.js", "./js/modules/settings/cloudSection.js", "./js/modules/settings/backupSection.js", "./js/modules/settings/teacherProfileCard.js", "./js/modules/settings/deviceTeacherSection.js", "./js/modules/settings/devicePinSection.js", "./js/modules/settings/pwaInstallCard.js", "./js/modules/settings/deviceProfileCard.js", "./js/modules/settings/directorySyncCard.js", "./js/modules/settings/deviceMeshCardList.js", "./js/modules/settings/deviceMeshSyncBanner.js", "./js/modules/settings/deviceMeshCard.js", "./js/modules/settings/settingsModal.js", "./js/modules/settings/settingsView.js", "./js/modules/info/infoModal.js", "./js/modules/info/changelogData.js", "./js/modules/info/changelogModal.js", "./js/modules/info/updateNotifier.js",
  "./js/modules/auth/deviceProfile.js", "./js/modules/auth/splashModal.js", "./js/modules/auth/guestMode.js", "./js/modules/auth/guestBarUI.js", "./js/modules/auth/lockScreen.js", "./js/modules/auth/lockScreenPin.js", "./js/modules/auth/lockScreenChoice.js", "./js/modules/auth/suspendedSessionService.js", "./js/modules/auth/suspendedSessionPrompt.js", "./js/modules/auth/teacherSetupModal.js", "./js/modules/auth/firstRunWizard.js", "./js/modules/auth/guestOnboarding.js",
  "./js/modules/sync/sha256.js", "./js/modules/sync/payloadCompressor.js", "./js/modules/sync/cryptoUtils.js", "./js/modules/sync/deviceInfo.js", "./js/modules/sync/pairingHistory.js", "./js/modules/sync/qrGf.js", "./js/modules/sync/qrMatrix.js", "./js/modules/sync/qrSvg.js", "./js/modules/sync/deviceMeshDB.js", "./js/modules/sync/deviceMesh.js", "./js/modules/sync/deviceMeshHash.js", "./js/modules/sync/pairingModal.js", "./js/modules/sync/pairingSuccessUI.js", "./js/modules/sync/pairingResultUI.js", "./js/modules/sync/syncSummaryFormatter.js", "./js/modules/sync/mqttEncoder.js", "./js/modules/sync/signalingReceiver.js", "./js/modules/sync/webrtcSignaling.js", "./js/modules/sync/webrtcChunker.js", "./js/modules/sync/webrtcPeer.js", "./js/modules/sync/localSyncHandlers.js", "./js/modules/sync/localSyncSender.js", "./js/modules/sync/smartMerge.js", "./js/modules/sync/localSyncPeer.js", "./js/modules/sync/localSyncCommands.js", "./js/modules/sync/localSyncBadge.js", "./js/modules/sync/directorySync.js", "./js/modules/sync/remoteUnlockBanner.js", "./js/modules/sync/syncConfirmModal.js",
